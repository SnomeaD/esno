<template>
    <div class="jumbotron">
        <h3 class="display-3"><img class="img-avatar" :src="toon.thumbnail" alt="Avatar" height="64px" width="64px"> {{toon.name}} - {{toon.realm}}</h3>
        ...
        <p>
            ...
            Audit:<i v-if="toon.audit.problems.length === 0" class="fa fa-check"></i><br/>
        </p>
